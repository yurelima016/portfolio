...
**Visite a versão (em desenvolvimento):** `[SEU LINK AQUI]` (Ex: https://yure-lima.github.io/portfolio/)
...
- **CSS3:** Para toda a estilização, utilizando:
  ...
  - **Transições (`transition`):** Para animações suaves, como o preenchimento das barras de skill.
- **JavaScript (ES6+):** Para toda a interatividade e lógica do site.
  - **`data-attributes`:** Utilizados para vincular o DOM ao JavaScript de forma limpa, separando a lógica do estilo.

---

## ✨ Funcionalidades Implementadas

Mesmo em desenvolvimento, o site já conta com algumas seções interativas:

### 1. Seção "About Me"

- Cálculo automático da minha idade em tempo real.
...
- **[ ] Seção de Contato:** Um formulário funcional para envio de mensagens.
- **[ ] Menu de Navegação:** Ativar o menu (header) para navegação _sticky_ e _scroll suave_.
- **[ ] Tema Dark/Light:** Implementar a lógica do botão para trocar o tema do site.
...
```bash
# Clone o repositório
git clone https://github.com/yurelima016/portfolio.git
