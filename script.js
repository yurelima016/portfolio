...
const skillLogoContainerEl = document.querySelector(
  "[data-skill-logo-container]"
);
...
const skillLogos = {
  ...
  github:
    '<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg" alt="GIT-HUBLOGO" />',
};
...
const translations = {
  ...
  pt: {
    ...
    about_p1:
      'Olá! Eu sou <span class="about__highlight">Yure Lima</span>, um desenvolvedor <span class="about__highlight">front-end</span> de ',
    about_p2:
...
const navLinks = document.querySelectorAll(".header__nav-item-link");
